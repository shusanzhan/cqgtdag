...
window.onload = function() {
	var depIds="${user.departmentIds}";
	var depNames="${user.departmentNames}";
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="user.userId" id="userId"
					value="${user.userId }" class="large text" title="用户ID" url="${ctx }/user/validateUser"	checkType="string,5,20" tip="用户名不能为空,并且5-20个字符"><span style="color: red;">*</span></td>
