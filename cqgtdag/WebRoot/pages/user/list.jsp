...
<div class="listOperate">
	<div class="operate">
		<a class="but button" href="javascript:void();" onclick="window.location.href='${ctx}/pages/user/add.jsp'">添加</a>
		<a class="but button" href="javascript:void(-1);" onclick="$.utile.deleteIds('${ctx }/user/delete','searchPageForm')">删除</a>
   </div>
...
<c:forEach var="user" items="${page.result }">
	<tr height="32" align="center">
		...
		<td><a href="javascript:void(-1)" class="aedit"	onclick="window.location.href='${ctx }/user/edit?dbid=${user.dbid}'">编辑</a>
			<a href="javascript:void(-1)"  class="aedit"	onclick="$.utile.deleteById('${ctx }/user/delete?dbids=${user.dbid}','searchPageForm')">删除</a>
