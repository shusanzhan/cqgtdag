		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="user.userId" id="userId"
					value="" url="${ctx }/user/validateUser" class="large text" title="用户ID"	checkType="string,5,20" tip="用户名不能为空,并且5-20个字符"><span style="color: red;">*</span></td>
			...
			<tr height="42">
				<td class="formTableTdLeft" >密码:&nbsp;</td>
				<td ><input type="password" name="user.password" id="password"
					value="" class="large text" title="用户名"	checkType="string,6,20" tip="密码不能为空,密码长度为6,20"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft" >生日:&nbsp;</td>
				<td ><input type="text" name="staff.birthday" id="birthday"
					value="" readonly="readonly" class="large text" onFocus="WdatePicker({isShowClear:false,readOnly:true})"></td>
			</tr>
			<tr height="32">
