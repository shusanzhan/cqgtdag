...
<div style="width: 510px;text-align: right;margin: 0 auto;padding-right: 18px;margin-top: 5px;">
		<a class="ui-state-default" href="javascript:void(-1);" onclick="ok();">添加</a>
	...
	<div style="width: 510px; height: 360px;margin: 0 auto;">
		...
		<div style="width: 232px; float: left; margin-right: 12px;">
			<div>员工将属于一下部门</div>
			<ul id="treeDemo2"  style="line-height: 32px;border: 1px solid #629DDD;height: 370px; margin-top: 5px;  overflow-x: auto;  width: 232px;">
			</ul>
		</div>
	</div>
</body>
