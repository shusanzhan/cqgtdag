		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			...
			<tr height="42">
				...
				<td ><input type="text" name="enterprise.webAddress" id="webAddress"
					value="${enterprise.webAddress }" class="largeX text" checkType="integer" canEmpty="Y" tip="必须输入数字" title="网址"></td>
			</tr>
			<tr height="42">
			...
			<tr height="42">
				...
				<td ><input type="text" name="enterprise.bank" id="bank"
					value="${enterprise.bank }" class="largeX text" checkType="integer" canEmpty="Y" tip="开户银行必须输入数字" title="开户银行"></td>
			</tr>
			<tr height="42">
