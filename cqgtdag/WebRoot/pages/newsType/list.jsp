...
,
		...
		$(document).ready(function(){
				...
				if(null!=json&&json!=1){
					...
					zTree = $.fn.zTree.getZTreeObj("treeDemo");
					rMenu = $("#rMenu");
					$("#treeDemo").append("<li>暂无新闻分类信息信息！<br>点击右键添加新闻分类信息！</li>");
				}
			});
		});
		//-->
...
<div class="content_wrap" style="margin-left: 24px;margin-top: -12px;height: 580px;">
	...
	<div class="right" style="height: 520px;float: left;margin-left: 12px;" >
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 92%;margin-top: 5px;" >
			<tr height="42" >
				<td colspan="2" style="color: red;font-size: 12px;text-indent: 24px;">
					说明：新闻分类管理可以对新闻进行添加、编辑、删除操作。
					1、选中新闻点击鼠标右键，在弹出框上面有增加、编辑、删除操作。
				</td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft" style="width: 100px">名称:&nbsp;</td>
				<td ><input type="text" name="name" id="name" readonly="readonly"	value="" class="text largeXX" title="新闻类型名称"	></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft" style="width: 100px">排序:&nbsp;</td>
				<td ><input type="text" name="orderNum" id="orderNum" readonly="readonly"	value="" class="text largeXX"></td>
			</tr>
			<tr height="42">
				<td class="formTableTdLeft" style="width: 100px">描述:&nbsp;</td>
				<td ><textarea readonly="readonly" name="note" id="note"
					 class="textarea large" title="描述" cols="60" rows="8"></textarea></td>
			</tr>
		</table>
	</div>
	<div class="clear"></div>
