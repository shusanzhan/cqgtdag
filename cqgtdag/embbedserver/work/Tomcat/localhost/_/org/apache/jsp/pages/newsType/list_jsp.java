 ...
 * Generated at: 2014-07-05 08:03:07 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/pages/newsType/../commons/taglib.jsp", Long.valueOf(1404478048744L));
  }
...
response.setDateHeader("Expires", 0); 
      ...
      out.write("\t\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/getNewsTypeByDbid?dbid=\"+treeNode.id+\"&time=\"+new Date(),{},function (data){\r\n");
      out.write("\t\t\t\t\t\tif(data=='error'){\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t//绑定查询结果\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#name\").val(data.name);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#orderNum\").val(data.orderNum);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#note\").val(data.note);\r\n");
      out.write("\t\t\t\t\t\t}\t\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/edit?parentId='+parentId+\"&menu=\"+menu,'添加',550,300);\r\n");
      out.write("\t\t\thideRMenu();\r\n");
      ...
      out.write("\t\t\t$.utile.openDialog('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/edit?dbid='+nodes.id,'编辑',550,300);\r\n");
      out.write("\t\t\thideRMenu();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction orderNum() {\r\n");
      out.write("\t\t\tvar nodes = zTree.getSelectedNodes()[0];\r\n");
      out.write("\t\t\t$.utile.openDialog('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/orderNum?dbid='+nodes.id,'排序',750,500);\r\n");
      out.write("\t\t\thideRMenu();\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(childrens==undefined||childrens.length==0){\r\n");
      out.write("\t\t\t\tart.dialog({\r\n");
      ...
      out.write("\t\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/delete?dbid=\"+node.id, { } ,function callback(data){\r\n");
      ...
      out.write("\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/newsType/jsonNewsType?timeStamp=\"+new Date()+\"&urlType=1\", { } ,function callback(json){  \r\n");
      ...
      out.write("\t\t\t\t\tzTree = $.fn.zTree.getZTreeObj(\"treeDemo\");\r\n");
      out.write("\t\t\t\t\trMenu = $(\"#rMenu\");\r\n");
      out.write("\t\t\t\t\t$(\"#treeDemo\").append(\"<li>暂无新闻分类信息信息！<br>点击右键添加新闻分类信息！</li>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//-->\r\n");
      ...
      out.write("</div>\t\r\n");
      out.write("<div class=\"content_wrap\" style=\"margin-left: 24px;margin-top: -12px;height: 580px;\">\r\n");
      out.write("\t<div class=\"zTreeDemoBackground\" style=\"float: left;\">\r\n");
      out.write("\t\t<ul id=\"treeDemo\" class=\"ztree\" style=\"height: 510px;\"></ul>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"right\" style=\"height: 520px;float: left;margin-left: 12px;\" >\r\n");
      out.write("\t\t<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 92%;margin-top: 5px;\" >\r\n");
      out.write("\t\t\t<tr height=\"42\" >\r\n");
      out.write("\t\t\t\t<td colspan=\"2\" style=\"color: red;font-size: 12px;text-indent: 24px;\">\r\n");
      out.write("\t\t\t\t\t说明：新闻分类管理可以对新闻进行添加、编辑、删除操作。\r\n");
      out.write("\t\t\t\t\t1、选中新闻点击鼠标右键，在弹出框上面有增加、编辑、删除操作。\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr height=\"42\">\r\n");
      out.write("\t\t\t\t<td class=\"formTableTdLeft\" style=\"width: 100px\">名称:&nbsp;</td>\r\n");
      out.write("\t\t\t\t<td ><input type=\"text\" name=\"name\" id=\"name\" readonly=\"readonly\"\tvalue=\"\" class=\"text largeXX\" title=\"新闻类型名称\"\t></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr height=\"42\">\r\n");
      out.write("\t\t\t\t<td class=\"formTableTdLeft\" style=\"width: 100px\">排序:&nbsp;</td>\r\n");
      out.write("\t\t\t\t<td ><input type=\"text\" name=\"orderNum\" id=\"orderNum\" readonly=\"readonly\"\tvalue=\"\" class=\"text largeXX\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr height=\"42\">\r\n");
      out.write("\t\t\t\t<td class=\"formTableTdLeft\" style=\"width: 100px\">描述:&nbsp;</td>\r\n");
      out.write("\t\t\t\t<td ><textarea readonly=\"readonly\" name=\"note\" id=\"note\"\r\n");
      out.write("\t\t\t\t\t class=\"textarea large\" title=\"描述\" cols=\"60\" rows=\"8\"></textarea></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
