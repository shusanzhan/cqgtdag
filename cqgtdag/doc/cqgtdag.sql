...
Source Database       : cqgtdag

Target Server Type    : MYSQL
Target Server Version : 50616
File Encoding         : 65001

Date: 2014-06-24 22:52:50
*/
...
-- ----------------------------
INSERT INTO `enterprise` VALUES ('2', '重庆档案局', '023-62136558', '023-62136558', '111122', '111', '111', 'shusanzhan@163.com', '111', '111', '<p>\r\n	实施</p>\r\n');
...
INSERT INTO `loginlog` VALUES ('859', '3', 'admin', '2014-06-24 20:55:03', '192.168.1.101', '???', '9AB2E7A3E1E9EA198841FEB0C6109082');
INSERT INTO `loginlog` VALUES ('860', '3', 'admin', '2014-06-24 21:08:51', '192.168.1.101', '???', 'A59E0653B5686F0466DD1037348E0F69');
INSERT INTO `loginlog` VALUES ('861', '3', 'admin', '2014-06-24 21:10:39', '192.168.1.101', '局域网', '53A055B592B513C45F0B6304F9250D81');
INSERT INTO `loginlog` VALUES ('862', '3', 'admin', '2014-06-24 22:13:35', '192.168.1.101', '局域网', '81E150BD0C0C0DBE58A74ACA149223D5');
INSERT INTO `loginlog` VALUES ('863', '3', 'admin', '2014-06-24 22:32:01', '192.168.1.101', '局域网', 'A6E5DB23A777B07CBD5652CBEB3AA110');
INSERT INTO `loginlog` VALUES ('864', '3', 'admin', '2014-06-24 22:35:28', '192.168.1.101', '局域网', 'FBF7E840E3F452D8CCC294E1CEAD149D');
...
CREATE TABLE `news` (
  ...
  `releasePerson` int(11) DEFAULT NULL,
  `releaseDate` datetime DEFAULT NULL,
  `readNum` int(11) DEFAULT NULL,
  `isBannerPicture` bit(1) DEFAULT NULL,
  `isOnTime` bit(1) DEFAULT NULL,
  `isLatestNew` bit(1) DEFAULT NULL,
  `isStop` bit(1) DEFAULT NULL,
  `titlePicture` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `newsTypeDbid` int(11) DEFAULT NULL,
  `attach` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  `introduction` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  `contentText` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`dbid`),
  KEY `newsTypeDbid` (`newsTypeDbid`),
  CONSTRAINT `news_ibfk_1` FOREIGN KEY (`newsTypeDbid`) REFERENCES `newstype` (`dbid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- Records of newstype
-- ----------------------------
INSERT INTO `newstype` VALUES ('1', '重庆档案局', null, null, null);
INSERT INTO `newstype` VALUES ('2', '新闻', '2', '1', '1');
...
INSERT INTO `resource` VALUES ('56', null, '', '公共消息', '16', '0', '0');
INSERT INTO `resource` VALUES ('57', null, '/member/queryList', '文件通知', '56', '1', '0');
INSERT INTO `resource` VALUES ('59', null, '', '基础设置', '16', '0', '4');
INSERT INTO `resource` VALUES ('94', null, '/onlineBooking/queryList', '内部消息', '56', '1', '4');
INSERT INTO `resource` VALUES ('102', null, '/emergencyHelp/queryList', '公共通讯录', '56', '1', '4');
INSERT INTO `resource` VALUES ('103', null, '', '网站管理', '16', '0', '2');
INSERT INTO `resource` VALUES ('104', null, '/news/queryList', '新闻管理', '103', '1', '1');
INSERT INTO `resource` VALUES ('105', null, '/newsType/queryList', '新闻类型', '103', '1', '2');
INSERT INTO `resource` VALUES ('106', null, '/slide/queryList', '滚动图片', '103', '1', '3');
INSERT INTO `resource` VALUES ('107', null, '/friendLink/queryList', '友情链接', '103', '1', '4');
INSERT INTO `resource` VALUES ('108', null, '/err/er', '地址质料目录管理', '103', '1', '5');
...
INSERT INTO `roleresource` VALUES ('1', '104');
INSERT INTO `roleresource` VALUES ('1', '51');
INSERT INTO `roleresource` VALUES ('1', '105');
...
INSERT INTO `roleresource` VALUES ('1', '108');
...
CREATE TABLE `slide` (
  `dbid` int(8) NOT NULL AUTO_INCREMENT,
  `bussiId` int(8) DEFAULT '0',
  `typeid` int(4) DEFAULT '0',
  `picUrl` varchar(120) CHARACTER SET utf8 DEFAULT NULL,
  `title` varchar(32) CHARACTER SET utf8 DEFAULT NULL,
  `description` text CHARACTER SET utf8,
  `url` varchar(120) CHARACTER SET utf8 DEFAULT NULL,
  `display` bit(1) DEFAULT b'1',
  `sort` smallint(2) DEFAULT '0',
  `createTime` datetime DEFAULT NULL,
  `modifyTime` datetime DEFAULT NULL,
  PRIMARY KEY (`dbid`),
  KEY `uid` (`bussiId`)
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('3', 'admin', '13880880171', '', 'czvip@qq.com', '陈卓', 'b594510740d2ac4261c1b2fe87850d08', '78', '3404703', '1');
INSERT INTO `user` VALUES ('12', 'liwen', '13882108839', '', '', '李文', 'df673ff20ecfc6295abd11b1c4675d3a', null, '', '1');
INSERT INTO `user` VALUES ('13', 'gaoxiang', '13982295539', '', '', '高翔', '5d88c62c22b03a20e09ed7bd10e9fa22', '67', '', '1');
INSERT INTO `user` VALUES ('14', 'zengyan', '13982030606', '', '', '曾艳', '3bccfcc06ec3ffd4ef0ff1232bfadba2', null, '', '1');
INSERT INTO `user` VALUES ('15', 'kefubu01', '', '028-87464321', '', '客服', '647da531b10bb84430ccd46ca746aec6', null, '', '1');
INSERT INTO `user` VALUES ('16', 'pengchong', '13086600816', '', '', '彭崇', 'd1a3ff158a03cc5e8b0adb83c25f2e72', null, '', '1');
INSERT INTO `user` VALUES ('17', 'liuxuebing', '13699034786', '', '', '刘学兵', '8a445e9a63102b2ad0d5b97f8236d144', null, '', '1');
INSERT INTO `user` VALUES ('18', 'mincong', '', '', '', '闵聪', 'd57a3cba739a808f2f5657b2c08dd16d', null, '', '1');
INSERT INTO `user` VALUES ('19', 'liuzuxing', '', '', '', '刘祖星', '5d6dc4c14607514933230d66670ae613', null, '', '1');
INSERT INTO `user` VALUES ('20', 'chengyang', '', '', '', '程洋', 'c7d89e3b2bd087fe27013cbfc793918f', null, '', '1');
INSERT INTO `user` VALUES ('21', 'huangjinyou', '', '', '', '黄金友', '574b184488b65e3cb775a00c857eb4fc', null, '', '1');
INSERT INTO `user` VALUES ('22', 'mengjian', '', '', '', '孟剑', '01456ed27c1063b3aa2004a169259756', null, '', '1');
INSERT INTO `user` VALUES ('23', 'gaochunhua', '', '', '', '高春华', 'f7958b5a363863c9a89d33495c25d6bf', null, '', '1');
INSERT INTO `user` VALUES ('24', 'renchenxi', '', '', '', '任晨曦', 'c42b5acaea13265e7357b2f4d5c0fbdd', null, '', '1');
INSERT INTO `user` VALUES ('25', 'taoxin', '', '', '', '陶欣', '7cad2d4783005b2739b58dc37dff1b32', null, '', '1');
INSERT INTO `user` VALUES ('26', 'zuohongsong', '', '', '', '左洪松', '48b8376d09445bf66049ea8a6d60d613', null, '', '1');
INSERT INTO `user` VALUES ('27', 'liqijun', '', '', '', '李琪君', '3ee97154a4de329f1cd88488887053ab', null, '', '1');
INSERT INTO `user` VALUES ('28', 'tanqin', '', '', '', '谭琴', '98fc73608de4956f4dd83272a52b4f6d', null, '', '1');
INSERT INTO `user` VALUES ('29', 'panwei', '', '', '', '潘伟', 'ee706565ef8deab8041e463e86c7641e', null, '', '1');
INSERT INTO `user` VALUES ('30', 'tianweiyong', '', '', '', '田维雍', '4de569d7db99f4910591158f797fe28f', null, '', '1');
INSERT INTO `user` VALUES ('31', 'yuhaibao', '', '', '', '于海宝', '4ab4d767755c2b31bb1e43dcbcec4c3c', null, '', '2');
INSERT INTO `user` VALUES ('32', 'guanguotong', '', '', '', '关国通', 'd44210fbd16d33750ad9db8e0fa153d2', null, '', '1');
INSERT INTO `user` VALUES ('33', 'heli', '', '', '', '何梨', '1a207772c0f8a3cf49d3ee2ccec3369e', '70', '', '1');
INSERT INTO `user` VALUES ('34', 'zhaoshuai', '', '', '', '赵帅', '008a0e0af58e0a465e56dd0d173f9556', null, '', '1');
INSERT INTO `user` VALUES ('35', 'zhengyang', '', '', '', '郑阳', '99a0e15c937e1d84ff4f8a263683babd', null, '', '1');
INSERT INTO `user` VALUES ('36', 'tanhui', '', '', '', '谭辉', '486cadf9acabc68c4d853097fe88fb5e', null, '', '1');
INSERT INTO `user` VALUES ('37', 'liurui', '', '', '', '刘锐', 'b8b0c75f932fad3c3cf5523bc8888f59', null, '', '1');
INSERT INTO `user` VALUES ('38', 'shijin', '', '', '', '石进', 'a114a0c4d1ac836d7d702408e0ee5e99', null, '', '1');
INSERT INTO `user` VALUES ('39', 'zhaochendi', '', '', '', '赵晨笛', 'd457977b485238bf5d99e6ec83a05a81', null, '', '1');
INSERT INTO `user` VALUES ('40', 'wlb', '', '', '', '物流', '5692385efe975f0b0e0db132d0f75035', null, '', '1');
