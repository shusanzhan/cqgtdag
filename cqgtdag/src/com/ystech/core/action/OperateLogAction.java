...
import com.ystech.core.service.OperateLogManageImpl;
...
public class OperateLogAction extends BaseController{
	...
	public String queryList() throws Exception {
		...
		if(null!=name&&name.trim().length()>0){
			 page= operateLogManageImpl.pageQuery(pageNo, pageSize, "from OperateLog where operator like '%"+name+"%' order by operatedate DESC", new Object[]{});
		}else{
			page= operateLogManageImpl.pageQuery(pageNo, pageSize, "from OperateLog order by operatedate DESC", new Object[]{});
		}
