...
import com.ystech.core.model.LoginLog;
import com.ystech.core.model.User;
import com.ystech.core.security.SecurityUserHolder;
import com.ystech.core.service.LoginLogManageImpl;
...
public class LoginLogAction extends BaseController{
	...
	public String queryList() throws Exception {
		...
		Page<LoginLog> page= loginLogManageImpl.pageQuery(pageNo, pageSize, "from LoginLog where userId=? order by loginDate DESC", new Object[]{user.getDbid()});
